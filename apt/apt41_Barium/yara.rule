/*
  Yara Rule Set
  Author: Florian Roth, Jorge Felix Gonzalez Arias
  Date: 2019-08-07
  Identifier: APT41
...
rule APT_APT41_POISONPLUG_3 {
  meta:
      ...
      author = "Florian Roth (Nextron Systems), Jorge Felix Gonzalez Arias"
      reference = "https://www.fireeye.com/blog/threat-research/2019/08/apt41-dual-espionage-and-cyber-crime-operation.html"
      date = "2019-08-07"
      score = 80
...
rule autoyar_exe_151257e9dfda {
   meta:
      description = "7.dll.exe - 151257e9dfda476cdafd9983266ad3255104d72a66f9265caa8417a5fe1df5d7"
      author = "ThreatZone, Jorge Felix Gonzalez Arias"
      reference = "Default reference"
      date = "2025-05-28"
      hash1 = "151257e9dfda476cdafd9983266ad3255104d72a66f9265caa8417a5fe1df5d7"
   strings:
      $s1 = "AppPolicyGetProcessTerminationMethod" fullword ascii /* score: '20.00'*/
      $s2 = "operator<=>" fullword ascii /* score: '9.00'*/
      $s3 = ".data$rs" fullword ascii /* score: '8.00'*/
      $s4 = "operator co_await" fullword ascii /* score: '9.00'*/
      $s5 = "operator \"\"" fullword ascii /* score: '9.00'*/
   condition:
      uint16(0) == 0x5a4d and filesize < 134KB and filesize > 110KB and
      ( pe.exports("plus") or all of ($s*) )
}
