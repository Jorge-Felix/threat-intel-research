...
rule Mirai_Botnet_Detection : MALW
{
	meta:
		...
		// SHA256 hashes of the obtained samples
		...
		// some other IOCs identified throughout my test
		ip_1 = "185.125.190.49"
		ip_2 = "91.189.91.49"
		ip_3 = "224.0.0.251"
	...
	strings:
		// Characteristic strings of Mirai
		$miname = "Myname--is:"
	...
	condition:
		...
		// Detection by behavioral characteristics
		(
...
{
	meta:
		description = "Mirai Botnet - Hash SHA256 1"
		author = "Jorge Felix Gonzalez Arias"
		date = "2025-07-14"
		version = "1.0"
		credits = "Based on original work by Felipe Molina / @felmoltor"
...
{
	meta:
		description = "Mirai Botnet - Hash SHA256 2"
		author = "Jorge Felix Gonzalez Arias"
		date = "2025-07-14"
		version = "1.0"
		credits = "Based on original work by Felipe Molina / @felmoltor"
...
{
	meta:
		description = "Mirai Botnet - Hash SHA256 3"
		author = "Jorge Felix Gonzalez Arias"
		date = "2025-07-14"
		version = "1.0"
		credits = "Based on original work by Felipe Molina / @felmoltor"
...
{
	meta:
		description = "Mirai Botnet - Specific indicators"
		author = "Jorge Felix Gonzalez Arias"
		date = "2025-07-14"
		version = "1.0"
		credits = "Based on original work by Felipe Molina / @felmoltor"
	...
	strings:
		...
		// General characteristics of Mirai
		$miname = "Myname--is:"
		$iptables1 = "busybox iptables -A INPUT -p tcp --destination-port 7547 -j DROP"
		$procnet = "/proc/net/tcp"
